...
**Chunk size:** One document per chunk (most documents are approximately 200–500 characters).

**Overlap:** None.

**Reason:** Most campus-life documents focus on one topic, so keeping each document together preserves the context and avoids separating related information.
...
**Chunk 2** — source: `course_biol_160.txt#0.txt` — produced by: `chunker.py::split_documents`
