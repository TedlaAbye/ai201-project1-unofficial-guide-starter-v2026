...
QUESTIONS = [
    # {"question": "...", "expects": "..."},
    {"question": "When is the deadline to add a course?", "expects": "end of the second week"},
    {"question": "How is the housing lottery determined for juniors and seniors?", "expects": "accumulated credit hours"},
